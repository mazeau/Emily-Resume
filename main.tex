...
\textbf{Data Science:} Pandas, statistical modeling, scikit-learn, NumPy, SciPy, RegEx\\
\textbf{Programming:} Git, GitHub, Python, MATLAB, SQL, Unix/Linux environment, SLURM, HPC, PyCharm, Bash, shell scripting\\
\textbf{Computational Chemistry:} Cantera, Chemkin, ASE, RMG, RDKit, AutoTST, Schrödinger
