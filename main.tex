...
\textbf{Programming:} Git, Python, C++, Cython, MATLAB, Unix/Linux environment, SLURM, HPC, PyCharm, Bash, Django, Docker\\
...
% \textbf{Security Clearance:} Q/TS//RD
...
\textbf{Postdoctoral Research Associate}, \href{https://www.ornl.gov/nnd}{\sl Nuclear Nonproliferation Division}, \href{https://www.ornl.gov/}{ORNL}, Oak Ridge, TN \hspace{0.2in}  \hfill Nov 2022 - Present
\begin{itemize}
    \item Simulated complex actinide systems using computational chemistry (DFT, VASP, NWChem) and molecular modeling (molecular dynamics, LAMMPS)
    \item Collaborated with the Uranium Science and Technology Center to develop a research-grade uranium processing facility
    \item Designed, hosted, and deployed an internal website for field data entry using Django and Docker with a PostgreSQL database
    \item Performed data analyses for complex meteorological data
...
\begin{itemize}
    \item
    \href{https://pubs.acs.org/doi/10.1021/acscatal.3c05436}{Implementing the Blowers–Masel Approximation to Scale Activation Energy Based on Reaction Enthalpy in Mean-Field Microkinetic Modeling for Catalytic Methane Partial Oxidation
    \textit{ACS Catal.} 2024 \textit{14} (XX), 8013–8029.}
