...
\textbf{Data Science:} Pandas, statistical modeling, scikit-learn, NumPy, SciPy, RegEx, SQL\\
\textbf{Programming:} Git, GitHub, Python, C++, MATLAB, Unix/Linux environment, SLURM, HPC, PyCharm, Bash, shell scripting\\
\textbf{Computational Chemistry:} Cantera, Chemkin, ASE, RMG, RDKit, AutoTST, Schrödinger, LAMMPS, VASP
...
\textbf{Postdoctoral Research Associate}, \href{https://www.ornl.gov/nnd}{\sl Computational Chemistry}, \href{https://www.ornl.gov/}{ORNL}, Oak Ridge, TN \hspace{0.2in}  \hfill Nov 2022 - Nov 2024
\begin{itemize}
    \item Modeled complex actinide systems using molecular dynamics and LAMMPS
    \item Calculated DFT for actinides using VASP
\end{itemize}
\vspace{-5pt}
